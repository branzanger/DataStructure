...
public class CustomerInterface {
	...
	public static void baseChoice(HashTable<MutualFundAccount> account_value, Hash<MutualFundAccount> account_name,
	...
	public static void purchaseFund(HashTable<MutualFundAccount> account_value, HashTable<MutualFundAccount> account_name,
			List<MutualFund> funds) {
		boolean valid = false;
		String input = "";
	...
	public static void sellFunds(HashTable<MutualFundAccount> account_value, HashTable<MutualFundAccount> account_name) {
	 ...
	 */
	public static void displayFunds(HashTable<MutualFundAccount> account_value, HashTable<MutualFundAccount> account_name) {
		String input = "";
		int choice = 0;
	...
	public static void update(MutualFund mf, HashTable<MutualFundAccount> account_value, BST<MutualFundAccount> account_name,
			int numOfShares) {
